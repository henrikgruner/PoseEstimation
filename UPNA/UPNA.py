...
RAW_DIR = 'Head_Pose_Database_UPNA'

'''
CLASS TAKEN FROM
https://github.com/Davmo049/Public_prob_orientation_estimation_with_matrix_fisher_distributions/blob/master/UPNA/UPNA.py
'''
...
class UPNA():
    def __init__(self, dataset_path, desired_image_size=224):
        ...
        train_users = ['User_01', 'User_02', 'User_03', 'User_04', 'User_05', 'User_06','User_07', 'User_08',]
