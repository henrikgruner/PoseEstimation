...
'''
Code is taken from https://github.com/leoshine/Spherical_Regression
'''


dataset_dir = '' # change to where you store datasets
...
class ModelNetSo3Subset():
    ...
    def __getitem__(self, idx):
        ...
        return image, extrinsic, class_idx, cad_id, intrinsic
...
def main():
    ...
    exit()
    for gg in range(10):    
        image, extrinsic, class_idx, hard, intrinsic, cad_idx = tr[gg]
